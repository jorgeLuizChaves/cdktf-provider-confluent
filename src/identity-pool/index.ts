// https://registry.terraform.io/providers/confluentinc/confluent/2.11.0/docs/resources/identity_pool
...
export interface IdentityPoolConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.11.0/docs/resources/identity_pool#description IdentityPool#description}
  */
  readonly description: string;
  /**
  * A name for the Identity Pool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.11.0/docs/resources/identity_pool#display_name IdentityPool#display_name}
  */
  readonly displayName: string;
  /**
  * A filter expression that must be evaluated to be true to use this identity pool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.11.0/docs/resources/identity_pool#filter IdentityPool#filter}
  */
  readonly filter: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.11.0/docs/resources/identity_pool#id IdentityPool#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.11.0/docs/resources/identity_pool#identity_claim IdentityPool#identity_claim}
  */
  readonly identityClaim: string;
  /**
  * identity_provider block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.11.0/docs/resources/identity_pool#identity_provider IdentityPool#identity_provider}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/confluentinc/confluent/2.11.0/docs/resources/identity_pool confluent_identity_pool}
*/
export class IdentityPool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentityPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/confluentinc/confluent/2.11.0/docs/resources/identity_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/confluentinc/confluent/2.11.0/docs/resources/identity_pool confluent_identity_pool} Resource
  *
  * @param scope The scope in which to define this construct
