// https://registry.terraform.io/providers/confluentinc/confluent/2.11.0/docs/data-sources/identity_provider
...
export interface DataConfluentIdentityProviderConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.11.0/docs/data-sources/identity_provider#display_name DataConfluentIdentityProvider#display_name}
  */
  readonly displayName?: string;
  /**
  * The ID of the Identity Provider (e.g., `op-abc123`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.11.0/docs/data-sources/identity_provider#id DataConfluentIdentityProvider#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/confluentinc/confluent/2.11.0/docs/data-sources/identity_provider confluent_identity_provider}
*/
export class DataConfluentIdentityProvider extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataConfluentIdentityProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/confluentinc/confluent/2.11.0/docs/data-sources/identity_provider#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/confluentinc/confluent/2.11.0/docs/data-sources/identity_provider confluent_identity_provider} Data Source
  *
  * @param scope The scope in which to define this construct
