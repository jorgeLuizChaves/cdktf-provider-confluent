// https://registry.terraform.io/providers/confluentinc/confluent/2.11.0/docs/resources/gateway
...
export interface GatewayConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.11.0/docs/resources/gateway#display_name Gateway#display_name}
  */
  readonly displayName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.11.0/docs/resources/gateway#id Gateway#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.11.0/docs/resources/gateway#aws_egress_private_link_gateway Gateway#aws_egress_private_link_gateway}
  */
  readonly awsEgressPrivateLinkGateway?: GatewayAwsEgressPrivateLinkGateway;
  /**
  * aws_private_network_interface_gateway block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.11.0/docs/resources/gateway#aws_private_network_interface_gateway Gateway#aws_private_network_interface_gateway}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.11.0/docs/resources/gateway#azure_egress_private_link_gateway Gateway#azure_egress_private_link_gateway}
  */
  readonly azureEgressPrivateLinkGateway?: GatewayAzureEgressPrivateLinkGateway;
  /**
  * environment block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.11.0/docs/resources/gateway#environment Gateway#environment}
  */
  readonly environment: GatewayEnvironment;
}
export interface GatewayAwsEgressPrivateLinkGateway {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.11.0/docs/resources/gateway#region Gateway#region}
  */
...
export interface GatewayAwsPrivateNetworkInterfaceGateway {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.11.0/docs/resources/gateway#zones Gateway#zones}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/confluentinc/confluent/2.11.0/docs/resources/gateway confluent_gateway}
*/
export class Gateway extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Gateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/confluentinc/confluent/2.11.0/docs/resources/gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/confluentinc/confluent/2.11.0/docs/resources/gateway confluent_gateway} Resource
  *
  * @param scope The scope in which to define this construct
