...
export function apiKeyManagedResourceEnvironmentToTerraform(struct?: ApiKeyManagedResourceEnvironmentOutputReference | ApiKeyManagedResourceEnvironment): any {
...
export function apiKeyManagedResourceEnvironmentToHclTerraform(struct?: ApiKeyManagedResourceEnvironmentOutputReference | ApiKeyManagedResourceEnvironment): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ApiKeyManagedResourceEnvironmentOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ApiKeyManagedResourceEnvironment | undefined {
  ...
  public set internalValue(value: ApiKeyManagedResourceEnvironment | undefined) {
    if (value === undefined) {
...
export function apiKeyManagedResourceToTerraform(struct?: ApiKeyManagedResourceOutputReference | ApiKeyManagedResource): any {
  ...
  return {
    ...
    environment: apiKeyManagedResourceEnvironmentToTerraform(struct!.environment),
  }
}
...
export function apiKeyManagedResourceToHclTerraform(struct?: ApiKeyManagedResourceOutputReference | ApiKeyManagedResource): any {
  ...
  const attrs = {
    ...
    environment: {
      value: apiKeyManagedResourceEnvironmentToHclTerraform(struct!.environment),
      isBlock: true,
      type: "list",
...
export class ApiKeyManagedResourceOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _environment = new ApiKeyManagedResourceEnvironmentOutputReference(this, "environment");
  public get environment() {
    return this._environment;
  }
  public putEnvironment(value: ApiKeyManagedResourceEnvironment) {
